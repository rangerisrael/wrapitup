                        ...
                        <div class="pm-product product-type-list  ">
                            ...
                            <div class="content">
                                ...
                                <div class="btn-block grid-btn">
                                    <a href="?add-to-cart=true&sub_id=<?=$_GET['sub_id']?>&id=<?=$product['sub_id']?>&success=true&message=<?=urlencode('Item has added to your cart')?>" class="btn btn-outlined btn-rounded btn-mid" tabindex="0">Add to
                                        Cart</a>
                                </div>
                                <div class="card-list-content ">
                                    ...
                                    <div class="btn-block d-flex">
                                        <a href="?add-to-cart=true&sub_id=<?=$_GET['sub_id']?>&id=<?=$product['id']?>&success=true&message=<?=urlencode('Item has added to your cart')?>" class="btn btn-outlined btn-rounded btn-mid"
