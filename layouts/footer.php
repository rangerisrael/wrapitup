            ...
            <div class="container">
                   ...
                   <!--  <div class="col-lg-2 col-sm-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer contact-block">
                            ...
                            <div class="single-footer-content">
                                <p>
                                    Subscribe to the Wrap it Up mailing list to receive updates on new arrivals, special
                                    offers
                ...
                <div class="footer-block-2 text-center">
                    ...
                    <!-- <div class="payment-block pt-3">
                        <img src="assets/image/icon-logo/payment-icons.png" alt="">
                    </div> -->
                </div>
            </div>
            <div class="footer-copyright">
                <p>© <?=date('Y')?> <a href="#">Wrap it Up</a> all rights reserved</a></p>
            </div>
        </footer>