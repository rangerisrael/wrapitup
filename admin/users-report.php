                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <a href="#" class="breadcrumb-item active">Users</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="table-responsive" >
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $i=1;?>
                                    <?php foreach(get_all_customer($from,$to) as $customers) { ?>
                                    <tr>
                                        <td style="width:1px"><?=$i++?></td>
                                        <td><?=($customers['firstname']  == '' ? 'NA' : $customers['firstname'].' '.$customers['surname'])?></td>
                                        <td><?=empty($customers['email']) ? 'N/A' : $customers['email']?></td>
                                        <td><?=empty($customers['contact']) ? 'N/A' : $customers['contact']?></td>
                                        <td><?=empty($customers['birthday']) ? 'N/A' : $customers['birthday']?></td>
                                        <td><?=empty($customers['age']) ? 'N/A' : $customers['age']?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
