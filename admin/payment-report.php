                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <a href="#" class="breadcrumb-item active">Payment</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group no-print">
                            ...
                            <?php if(isset($t)) { ?> 
                                <div class="btn-group float-right">
                                    ...
                                    <a href="payment-excel.php?from=<?=urlencode($from)?>&to=<?=urlencode($to)?>" title="Excel" class="btn btn-success btn-sm" id="excel"><i class="icon-file-excel"></i></a>
                                    <a href="payment-pdf.php?from=<?=urlencode($from)?>&to=<?=urlencode($to)?>" target="_blank" title="PDF" class="btn btn-warning btn-sm" id="pdf"><i class="icon-file-pdf"></i></a>
                                </div>
                            <?php } ?>
                        </div>
                        <?php if(isset($t)) { ?> 
                            ...
                            <div class="text-center text-uppercase">
                                <h6>Payments report from <?=$f?> to <?=$t?></h6>
                            </div>
                        <?php } ?>
                        ...
                        <div class="table-responsive" >
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $i=1;?>
                                    <?php foreach(get_all_payments($from,$to) as $payment) { ?>
                                    <tr>
