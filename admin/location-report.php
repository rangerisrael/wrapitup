                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <a href="#" class="breadcrumb-item active">Location</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group no-print">
                            ...
                            <?php if(isset($t)) { ?> 
                                <div class="btn-group float-right">
                                    ...
                                    <a href="location-excel-report.php?from=<?=urlencode($from)?>&to=<?=urlencode($to)?>" title="Excel" class="btn btn-success btn-sm" id="excel"><i class="icon-file-excel"></i></a>
                                    <a href="location-pdf-report.php?from=<?=urlencode($from)?>&to=<?=urlencode($to)?>" target="_blank" title="PDF" class="btn btn-warning btn-sm" id="pdf"><i class="icon-file-pdf"></i></a>
                                </div>
                            <?php } ?>
                        </div>
                        <?php if(isset($t)) { ?> 
                        ...
                        <div class="table-responsive" >
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $i=1;?>
                                    <?php foreach(get_locations($from,$to) as $customers) { ?>
                                        <tr>
